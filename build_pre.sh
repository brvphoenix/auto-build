...
curl -kLZ --compressed -o ${PATCH_DIR}/0001.patch https://github.com/qbittorrent/qBittorrent/compare/release-4.5.0...v4_5_x.patch
...
# Should be removed after v4.5.1
rm -rf ${PATCH_DIR}/0001-Unify-the-way-to-generate-the-language-list-in-WebUI.patch
